#ifndef OPAL_HTTP_BEAST_TRANSPORT_H_
#define OPAL_HTTP_BEAST_TRANSPORT_H_
...
namespace opal {
// opal/client/config.h — forward-declared so this header stays includable
...
class BeastServerTransport : public HttpServerTransport {
 public:
  ...
  struct Options {
    ...
    // opal/eventstream/async_event_stream.h are the intended loop).
...
#endif  // OPAL_HTTP_BEAST_TRANSPORT_H_
