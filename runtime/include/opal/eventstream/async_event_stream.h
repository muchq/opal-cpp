#ifndef OPAL_EVENTSTREAM_ASYNC_EVENT_STREAM_H_
#define OPAL_EVENTSTREAM_ASYNC_EVENT_STREAM_H_
  ...
  struct promise_type {
    ...
    void unhandled_exception() noexcept {
      ...
      try {
        ...
        std::clog << "opal: detached stream coroutine threw: " << e.what() << "\n";
      } catch (...) {
        std::clog << "opal: detached stream coroutine threw a non-std exception\n";
      }
#endif
    }
...
#endif  // OPAL_EVENTSTREAM_ASYNC_EVENT_STREAM_H_
