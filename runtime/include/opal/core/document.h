#ifndef OPAL_CORE_DOCUMENT_H_
#define OPAL_CORE_DOCUMENT_H_
...
// the wire codecs (opal/json, opal/cbor). Covers the Smithy document type
...
class Document {
 public:
  ...
  // Debug rendering (opal/core/print.h): JSON-ish — null/true/7/"x"/[..]/
