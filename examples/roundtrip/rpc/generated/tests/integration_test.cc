...
[[maybe_unused]] PingInput RandomPingInput([[maybe_unused]] Rng& rng) {
  PingInput v{};
  return v;
}

[[maybe_unused]] PingOutput RandomPingOutput([[maybe_unused]] Rng& rng) {
  PingOutput v{};
  return v;
}
...
class ScriptedHandler final : public RoundTripRpcHandler {
  public:
    ...
    std::optional<opal::Error> nextPingError;
